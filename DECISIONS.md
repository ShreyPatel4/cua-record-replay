...
| 49 | 2026-09-16 | 6 | The session file names the operator who took control; the result masks it. An audit trail that says `[REDACTED]` is useless, and a calling agent does not need staff identities. | Shrey | evidence/README.md, `tests/test_leaks.py` |
